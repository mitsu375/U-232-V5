...
if (isset($_GET['view']) && $_GET['view'] == "t") {
    ...
    // Top Torrents
    $HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['torrent_mostact_10']."</h4></div>";
    ...
    if ($counted == "10") {
        ...
        $HTMLOUT.= "<h6>".$lang['torrent_insuff_tt']."(" . $counted . ")</h6></div>";
    }
    $HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['torrent_mostsna_10']."</h4></div>";
...
if (isset($_GET['view']) && $_GET['view'] == "c") {
    ...
    // Top Countries
    $HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['country_mostact_10']."</h4></div>";
    ...
    if ($counted == "10") {
        ...
        $HTMLOUT.= "<h6>".$lang['country_insuff_ct']."(" . $counted . ")</h6></div>";
    }
    $HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['country_mostsna_10']."</h4></div>";
...
$HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['user_mostup_10']."</h4></div>";
...
if ($counted == "10") {
    ...
    $HTMLOUT.= "<h6>".$lang['user_insuff_up']."(" . $counted . ")</h6></div>";
}
$HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['user_mostdl_10']."</h4></div>";
...
if ($counted == "10") {
    ...
    $HTMLOUT.= "<h6>".$lang['user_insuff_dl']."(" . $counted . ")</h6></div>";
}
$HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['user_mostup_fst']."</h4></div>";
...
$HTMLOUT.= "<div class='article' style='text-align:center'><div class='article_header'><h4>".$lang['user_mostdl_fst']."</h4></div>";
